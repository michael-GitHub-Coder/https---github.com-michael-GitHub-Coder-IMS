    ...
    <div className="flex justify-center items-center md:h-screen ">
        <div className="bg-white px-5 py-4 flex flex-row gap-5 mmin-w-8xl">
          <div className="flex flex-col">
              ...
              <input type="text" placeholder="Enter the email" className="font-bold px-2 py-3 rounded-md text-gray-500  bg-gray-300 w-96 mt-7"/>
              <input type="text" placeholder="Enter the Password" className="font-bold px-2 py-3 rounded-md text-gray-500 bg-gray-300 w-96 mt-7"/>
              <p className="flex py-3 justify-end text-black font-bold cursor-pointer">Forgot Password?</p>
              <button className="font-bold px-2 py-3 rounded-md bg-gray-300 w-96  text-gray-500 hover:text-white cursor-pointer hover:bg-gray-500">Sign in</button>
