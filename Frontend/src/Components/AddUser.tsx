        ...
        <div className="flex flex-col justify-center px-50 min-w-6xl w-auto ml-10 mr-17 mt-5">
            <form>
                <div className="grid gap-6 mb-6  my-5">  
                    ...
                    <button type="submit" className="cursor-pointer w-full text-white bg-indigo-500 hover:bg-indigo-800 focus:ring-4 focus:outline-none focus:ring-indigo-300 font-medium rounded-lg text-sm  sm:w-auto px-5 py-2.5 text-center dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-indigo-800">Add User</button>
                </div>
